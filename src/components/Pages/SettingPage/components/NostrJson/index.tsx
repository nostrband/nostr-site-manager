...
export const NostrJson = memo(
  ({ siteId, isLoading: isSideLoading }: NostrJsonProps) => {
    ...
    return (
      <StyledSettingBlock id={SETTINGS_CONFIG.nostrJson.anchor}>
        ...
        <StyledFormFields>
          <FormControl
            disabled={!isEdit || isSideLoading}
            fullWidth
            size="small"
            error={isError}
          >
            <InputLabel htmlFor="nostr_json">
              Nostr.json file content
            </InputLabel>
            <OutlinedInput
              inputRef={inputRef}
              id="nostr_json"
